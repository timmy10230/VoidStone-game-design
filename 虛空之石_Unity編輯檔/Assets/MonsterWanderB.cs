...
public class MonsterWanderB : MonoBehaviour
{
    ...
    public Transform findGroundRotatePos;
    ...
    public bool isGroundEnemyRotate;
    bool viewGroundRotate
    {

        get
        {            
            Vector2 start1 = findGroundRotatePos.position;
            Vector2 end1 = new Vector2();
            ...
            isGroundEnemyRotate = Physics2D.Linecast(start1, end1, groundLayer);
            return isGroundEnemyRotate;
        }
    }
    ...
    void monsterMove()
    {
        ...
        switch (status)
        {
            case Status.idle:
                ...
                if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) <= 9f)
                {
                    status = Status.warn;
                }
                if (viewGroundRotate)
            ...
            case Status.warn:
                ...
                if (playerTransform)
                {
                    ...
                    else if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) > 9f)
                    {
                        status = Status.idle;
                    }
                    if (takeDamage)
            ...
            case Status.chase:
                ...
                if (playerTransform)
                {
                    ...
                    if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) <= 2.0f)
                    {
                        status = Status.atk;
            ...
            case Status.atk:
                ...
                if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) > 2.1f)
                {
