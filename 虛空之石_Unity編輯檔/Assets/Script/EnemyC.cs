...
public class EnemyC : Enemy
{
    ...
    void Awake()
    {
        mwC = GetComponent<MonsterWanderC>();
    ...
    public override void StateMachine()
    {
        ...
        ani.SetBool("Move", mwC.moving);
        ani.SetBool("Attack", mwC.attacking);
        mwC.enableMove = !state.IsTag("attack");
    ...
    public override void Damage(float dmg)
    {
        hp -= dmg;
        mwC.takeDamage = true;
        mwC.noDamageTime = mwC.maxNoDamageTime;
