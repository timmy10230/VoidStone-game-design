...
public class EnemyD : Enemy
{
    ...
    void Awake()
    {
        mwD = GetComponent<MonsterWanderD>();
    ...
    public override void StateMachine()
    {
        ...
        ani.SetBool("Move", mwD.moving);
        ani.SetBool("Attack", mwD.attacking);
        mwD.enableMove = !state.IsTag("attack");
    ...
    public override void Damage(float dmg)
    {
        hp -= dmg;
        mwD.takeDamage = true;
        mwD.noDamageTime = mwD.maxNoDamageTime;
