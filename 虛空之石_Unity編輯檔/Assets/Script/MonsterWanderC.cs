...
public class MonsterWanderC : MonoBehaviour
{
    ...
    void monsterMove()
    {
        ...
        switch (status)
        {
            case Status.idle:
                ...
                if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) <= 13f)
                {
                    status = Status.warn;
                }
                if (takeDamage)
            ...
            case Status.chase:
                ...
                if (playerTransform)
                {
                    ...
                    if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) <= 1.8f)
                    {
                        //Debug.Log("2.2f");
                        status = Status.atk;
            ...
            case Status.atk:
                ...
                else //if (Time.time <= nextAtk || Mathf.Abs(myTransform.position.x - playerTransform.position.x) > 2.15f)
                {
                    attacking = false;
                    //Debug.Log("2.15f");
                    //status = Status.chase;
                ...
                if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) > 1.7f)
                {
                    //Debug.Log("2.15f");
                    status = Status.chase;
