...
public class MonsterWanderD : MonoBehaviour
{
    ...
    void monsterMove()
    {
        ...
        switch (status)
        {
            ...
            case Status.chase:
                ...
                {
                    if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) >= 10f || viewGround)
                    {
                        status = Status.warn;
                        takeDamage = false;
                    }
