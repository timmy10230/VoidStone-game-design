...
public class MonsterWanderE : MonoBehaviour
{
        ...
        switch (status)
        {
            ...
            case Status.warn:
                ...
                if (playerTransform)
                {
                    ...
                    else if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) > 11f)
                    {
                        status = Status.idle;
                    }
                    if (takeDamage)
            ...
            case Status.chase:
                ...
                if (playerTransform)
                {
                    ...
                    if (Mathf.Abs(myTransform.position.x - playerTransform.position.x) <= 10.2f)
                    {
                        status = Status.atk;
